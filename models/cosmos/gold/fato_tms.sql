...
SELECT 
    ...
    -- =============================================
    a.equipe AS equipe,
    TO_DATE(CONCAT(a.ano, LPAD(a.mes, 2, '0')), 'YYYYMM') AS data,
    ...
    -- =============================================
    a.ocorrencia_id AS ocorrencia, 
    a.td AS tempo_deslocamento,
    a.te AS tempo_execucao,
    a.td + a.te AS tempo_servico,
    a.tms_ref AS tempo_medio_servico

FROM sb_performance.eqtl_corp.slv_tms_oe_ref a
...
WHERE CONCAT(a.ano, LPAD(a.mes, 2, '0')) = {{ month_ref }}
