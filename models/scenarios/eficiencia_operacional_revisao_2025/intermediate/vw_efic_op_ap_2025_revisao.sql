/* =====================================================================================
   EQTL_AP - UPS detalhado 2025 revisão
   Ajuste performance:
...
RET_NORM AS (
  ...
  FROM SB_PERFORMANCE.EQTL_AP.RETRABALHO ret
),

/* ---------------------------
   3) PP base (prazo SAP STC AP)
---------------------------- */
PP_BASE AS (
  SELECT *
  FROM {{ ref('prazo_sap_stc_ap')}}
