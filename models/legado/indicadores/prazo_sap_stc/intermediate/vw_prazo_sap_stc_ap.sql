...
'EQTL_AP' EMPRESA,
	...
	n.instalacao,
	n.nota,
	REPLACE(vv.equipe_execucao,'AP_','') equipe_execucao,
	--a.nr_visita,
	n.tipo_nota,
	n.texto_breve,
	n.grupo_codes,
...
FROM
	eqtlinfo_prd.eqtl_ap.notas_servicos n
LEFT JOIN eqtlinfo_prd.eqtl_ap.medidas_notas_servicos aa ON
	aa.nota = n.nota
LEFT JOIN eqtlinfo_prd.eqtl_ap.visitas_notas vv ON
	vv.nota = n.nota
	AND vv.data_final_servico = aa.data_conclusao_medida
LEFT JOIN eqtlinfo_prd.eqtl_ap.tab_regional_politica c ON
	n.estrut_regional_politica = c.estrutura_regional_politica
LEFT JOIN eqtlinfo_raw.oper_ap.code_medida cd ON
